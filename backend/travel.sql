...
insert into User (user_id, first_name, last_name, username, password) values (1, 'Daniele', 'Sissel', 'dsissel0', 'HkyWC7YL');
insert into User (user_id, first_name, last_name, username, password) values (2, 'Emmalyn', 'Dossantos', 'edossantos1', 'iJimlknPjwF');
insert into User (user_id, first_name, last_name, username, password) values (3, 'Rosella', 'Bruggen', 'rbruggen2', 'RQzmA3YIgN');
